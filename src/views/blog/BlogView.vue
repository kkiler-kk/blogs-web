      ...
      <el-main>
        ...
        <div class="me-view-card">
          ...
          <div class="me-view-author">
            <a class="">
              <img class="me-view-picture" @click="viewInfo" :src="article.author.avatar" />
            </a>
            <div class="me-view-info">
              <span @click="viewInfo">{{ article.author.nickName }}</span>
...
export default {
  ...
  computed: {
    ...
    title() {
      return `${this.article.title} - 文章 - Blogs之路`
    }
  },
  methods: {
    ...
    viewInfo() {
      ...
      if (followId == undefined && userId > 0) {
        ...
        this.$router.push({ path: '/newsuser/user/' + this.article.author.id })
      }
    },
    editArticle() {
